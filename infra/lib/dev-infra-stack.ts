...
export class DevInfraStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: cdk.StackProps) {
    ...
    const registry = new ecr.Repository(this, 'rewards-registry', {
      ...
      repositoryName: 'rewards-repo-dev',
    });

    const rdsMasterUser = new Secret(this, 'rewards-db-user-creds', {
      description: 'Master Creds for rewards DB - dev',
    ...
    const dbSg = new ec2.SecurityGroup(this, 'rewards-db-sg', {
      securityGroupName: 'rewards-db-dev',
      vpc,
    });
    ...
    const rewardsDb = new rds.DatabaseCluster(this, 'rewards-db', {
      clusterIdentifier: 'rewardsdb-dev',
    ...
    // cert for api.dev.alphaflashcards.com
    // cert for *.dev.alphaflashcards.com
    ...
    const wildcardSSLCertARN =
      'arn:aws:acm:us-east-1:597610889212:certificate/28a3c090-3f1e-4ba2-a8ad-09aa3fc1992c';
    ...
    const rewardsRestService =
      new pattern.ApplicationLoadBalancedFargateService(this, 'rewards', {
        ...
        loadBalancerName: 'alphaedu-rewards-lb-dev',
        domainName: 'rewards.api.dev.alphaflashcards.com',
    ...
    const hasuraService = new pattern.ApplicationLoadBalancedFargateService(
      ...
      'hasura',
      {
        ...
        loadBalancerName: 'rewards-hasura-alb-dev',
        domainName: 'rewards.graphql.dev.alphaflashcards.com',
        domainZone: hostedZone,
        certificate: wildcardSSLCert,
        publicLoadBalancer: true,
      },
